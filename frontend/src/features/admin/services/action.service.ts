...
export const actionService = {
  ...
  createAction: (payload: ActionPayload) => api.post<ApiResponse<Action>>('/actions', payload),
  updateAction: (id: string, payload: ActionPayload) => api.put<ApiResponse<Action>>(`/actions/${id}`, payload),
