...
import type { Showtime, ShowtimeSeatOverview } from '@/features/admin/types/showtime.type'
...
export const showtimeService = {
  ...
  getSeatOverview: (id: string) => api.get<ApiResponse<ShowtimeSeatOverview>>(`/showtimes/${id}/seat-overview`),
