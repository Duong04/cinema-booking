        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div class="col-span-1 md:col-span-2">
            <router-link to="/" class="flex items-center gap-2 mb-6">
              <div
                class="w-10 h-10 bg-red-600 rounded-xl flex items-center justify-center"
              >
            ...
            <p class="text-gray-500 max-w-sm leading-relaxed">
              The ultimate destination for movie lovers. Experience the latest
              blockbusters with state-of-the-art technology.
            </p>
          </div>
          <div>
            <h4
              class="text-white font-bold mb-6 uppercase tracking-widest text-sm"
            >
              Quick Links
            </h4>
            <ul class="space-y-4 text-gray-500 text-sm">
              <li>
                <router-link to="/" class="hover:text-red-500 transition-colors"
                  >Home</router-link
                >
              </li>
              <li>
