...
class MovieFactory extends Factory
{
    public function definition(): array
    {
        ...
        return [
            ...
            'banner_url' => 'https://picsum.photos/seed/movie-banner-' . fake()->unique()->uuid() . '/1280/720',
            ...
            'rating_score' => fake()->randomFloat(1, 6.5, 9.4),
            'rating_count' => fake()->numberBetween(12, 980),
